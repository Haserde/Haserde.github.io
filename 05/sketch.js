...
function processFlesch(data) {
  ...
  if (data.length === 0) {
    ...
    var delim = /\W+/;
    var words = data.split(delim);  //http://p5js.org/reference/#/p5/splitTokens
   ...
   // var r1 = l / totalWords;
    ...
    console.log(totalSentences, "sent");



    var read = r3 + r4 - 21.43;
    //4.71*r1 + (.5*words/sentences) 
   ...
   /* report += "Total Syllables: " + totalSyllables + "<br>";
    ...
    var fleschResults = createP(read);
